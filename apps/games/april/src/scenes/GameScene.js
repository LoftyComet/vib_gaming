 ...
 */
import { Scene, InputManager, CanvasRenderer, Camera, PortalBridge, Transform, Velocity, Health, Collider, Weapon, Player, Experience, Sprite, PlayerMovementSystem, MovementSystem, RenderSystem, } from '@vib/engine';
...
export class MyGameScene extends Scene {
    ...
    enter() {
        ...
        this.world.addComponent(this.playerId, new Weapon(DEFAULT_WEAPON.cooldown, DEFAULT_WEAPON.range, DEFAULT_WEAPON.damage, DEFAULT_WEAPON.projectileSpeed, DEFAULT_WEAPON.projectileCount, 0, DEFAULT_WEAPON.pierce));
    ...
    render(_alpha) {
        ...
        this.renderer.drawText('April 的游戏 — 在 GameScene.ts 中继续开发', this.renderer.width / 2, this.renderer.height / 2, '#9ca3af', 16, 'center');
    }
}
